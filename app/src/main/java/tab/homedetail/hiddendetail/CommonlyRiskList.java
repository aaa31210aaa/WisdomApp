...
public class CommonlyRiskList extends BaseActivity {
    @BindView(R.id.title_name)
    TextView title_name;
    @BindView(R.id.title_name_right)
    TextView title_name_right;
    @BindView(R.id.commonly_risk_list_add)
    FloatingActionButton commonly_risk_list_add;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_commonly_risk_list);
...
//        commonly_risk_list_add.setVisibility(View.VISIBLE);
    ...
    @OnClick(R.id.commonly_risk_list_add)
    void AddCommonly() {
    ...
    private Handler handler = new Handler() {
        ...
        public void dispatchMessage(Message msg) {
            ...
            switch (msg.what) {
                case 0:
                    ShowToast.showShort(CommonlyRiskList.this, R.string.loadSuccess);
...
//                                    }
                                ...
                                adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
                                    ...
                                    public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                                        if (SharedPrefsUtil.getValue(CommonlyRiskList.this, "userInfo", "usertype", "").equals("1")) {
                                            bean = (QyYhInformationBean.CellsBean) adapter.getData().get(position);
                                            Intent intent = new Intent(CommonlyRiskList.this, QyYhInfomationDetail.class);
                                            intent.putExtra("yhid", bean.getYhid());
                                            startActivity(intent);
                                        } else {
                                            bean = (QyYhInformationBean.CellsBean) adapter.getData().get(position);
                                            Intent intent = new Intent(CommonlyRiskList.this, HiddenDangerDetail.class);
                                            intent.putExtra("yhid", bean.getYhid());
                                            startActivity(intent);
                                        }
                                ...
                                ShowToast.showShort(CommonlyRiskList.this, R.string.getInfoErr);
                            }
                    ...
                    public void onError(Response<String> response) {
                        ...
                        refreshLayout.finishRefresh();
                        ShowToast.showShort(CommonlyRiskList.this, R.string.connect_err);
                    }
                });
    }
