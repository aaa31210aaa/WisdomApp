...
public class HiddenDangerDetail extends BaseActivity {
...
//    RecyclerView qy_yh_information_detail_recycler;
    ...
    protected void initData() {
        title_name.setText(R.string.commonlylist_detail_title);
        //检查权限
        if (ContextCompat.checkSelfPermission(this, WriteFilePermission) != PackageManager.PERMISSION_GRANTED && ContextCompat.checkSelfPermission(this, CreateDeleteFilePermission) != PackageManager.PERMISSION_GRANTED) {
        ...
        OkHttpUtils
                ...
                .execute(new StringCallback() {
                    ...
                    public void onError(Call call, Exception e, int id) {
                        e.printStackTrace();
                        dialog.dismiss();
                        ShowToast.showShort(HiddenDangerDetail.this, R.string.network_error);
                    }
...
//                                    bean.setDownopen(R.drawable.downloadfile);
                            ...
                            if (adapter == null) {
                                adapter = new FileListAdapter(HiddenDangerDetail.this, mDatas, filenames);
    ...
    public void Event(MessageEvent messageEvent) {
        ...
        if (messageEvent.getStatus() == 1) {
            ShowToast.showToastNowait(HiddenDangerDetail.this, "下载中...");
        } else if (messageEvent.getStatus() == 2) {
            ShowToast.showToastNowait(HiddenDangerDetail.this, "下载成功");
        } else if (messageEvent.getStatus() == 3) {
            ShowToast.showToastNowait(HiddenDangerDetail.this, "下载失败");
        }
    }
